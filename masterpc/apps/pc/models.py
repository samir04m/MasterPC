...
class Cpu(models.Model):
    ...
    img1_url = models.URLField('Image url', max_length=500)
...
class Storage(models.Model):
    manufacturer = models.ForeignKey(Manufacturer, on_delete=models.CASCADE)
    serie = models.CharField('Serie', max_length=40)
    ...
    def __str__(self):
        return "{} {} {} - {} {}".format(self.manufacturer.name, self.serie, self.getModel(), self.get_capacity_display(), self.storage_type)
...
class Case(models.Model):
    ...
    manufacturer_website = models.URLField('Manufacturer website', max_length=500)
    img1_url = models.URLField('Image url', max_length=500)
    # case_type = models.CharField('Type', max_length=20, choices=CaseType.choices, default=CaseType.MID_TOWER)
